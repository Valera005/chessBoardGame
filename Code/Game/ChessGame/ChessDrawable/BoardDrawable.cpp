...
#include "../Chess/MoveValidator/MoveValidator.h"
...
void BoardDrawable::HandleEvent(const sf::Event& eventChess)
{
	...
	case sf::Event::MouseButtonReleased:
		...
		if (selectedCell != nullptr)
		{
			...
			if (pointedCell != nullptr && pointedCell != selectedCell) //pointedCell->toShowGreyCircle == true
			{	

				Board::MoveExecutionStatus moveStatus = board.Execute(selectedCell->cell.GetCellIndex(), pointedCell->cell.GetCellIndex());
				if (moveStatus == Board::MoveExecutionStatus::Executed)
				{
					this->UpdateBoardState();
				}
				else if(moveStatus == Board::MoveExecutionStatus::KingChecked)
				{
